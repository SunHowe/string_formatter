...
namespace StringFormatter
{
    ...
    {
        private static readonly Dictionary<string, StringFormatFunc> _formatFuncs = new Dictionary<string, StringFormatFunc>();
        private static readonly Dictionary<string, StringFormatWithParametersFunc> _formatWithParametersFuncs = new Dictionary<string, StringFormatWithParametersFunc>();
